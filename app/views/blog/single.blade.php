...
<div class="col-xs-12">
    ...
    <div class="col-xs-8">
        ...
        <div class="col-xs-6">
            {{Form::text('title', Input::old('title'), array('class' => 'form-control','placeholder'=>'titre du commentaire'))}}
            <br />
        </div>
        ...
        <div class="col-xs-12 text-right">
            {{Form::textarea('content', null, array('class' => 'form-control','placeholder'=>'Contenu (*)','required'=>'required'))}}
            <br />
